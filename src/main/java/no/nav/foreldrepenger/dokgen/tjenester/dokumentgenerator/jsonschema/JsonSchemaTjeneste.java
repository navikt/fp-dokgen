package no.nav.foreldrepenger.dokgen.tjenester.dokumentgenerator.jsonschema;
...
import no.nav.foreldrepenger.dokgen.tjenester.dokumentgenerator.exceptions.DokgenSchemaValidationException;
