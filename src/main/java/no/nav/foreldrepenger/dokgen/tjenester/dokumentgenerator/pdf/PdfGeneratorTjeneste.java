package no.nav.foreldrepenger.dokgen.tjenester.dokumentgenerator.pdf;

import static no.nav.foreldrepenger.dokgen.tjenester.dokumentgenerator.utils.ContentUtil.lesRessursFra;
