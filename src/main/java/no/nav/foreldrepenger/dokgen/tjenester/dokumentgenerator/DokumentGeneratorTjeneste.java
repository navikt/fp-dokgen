...
import static no.nav.foreldrepenger.dokgen.tjenester.dokumentgenerator.utils.ContentUtil.hentPathForMal;
import static no.nav.foreldrepenger.dokgen.tjenester.dokumentgenerator.utils.ContentUtil.hentSchemaPathForMal;
import static no.nav.foreldrepenger.dokgen.tjenester.dokumentgenerator.utils.ContentUtil.lesRessursSomString;
import static no.nav.foreldrepenger.dokgen.tjenester.dokumentgenerator.utils.JacksonUtil.getJsonMapFromString;
...
import no.nav.foreldrepenger.dokgen.tjenester.dokumentgenerator.utils.HtmlUtil;
import no.nav.foreldrepenger.dokgen.tjenester.dokumentgenerator.utils.MarkdownUtil;
