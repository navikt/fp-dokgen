...
class SøknadVisningsdataTilpasserTest {
    ...
    void skalBehandleTomtEgenNæringObjektSomFraværende() {
        var resultat = SøknadVisningsdataTilpasser.tilpassForVisning("søknad-foreldrepenger",
    ...
    void skalIkkeBerikeAndreDokumentmaler() {
        ...
        assertThat(SøknadVisningsdataTilpasser.tilpassForVisning("annen-mal", input)).isSameAs(input);
    }
