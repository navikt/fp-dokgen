...
class DokGeneratorTjenesteTest {
    ...
    private DokGeneratorTjeneste dokGeneratorTjeneste;
    ...
    void setUp() {
        ...
        dokGeneratorTjeneste = new DokGeneratorTjeneste(jsonSchemaTjeneste, handlebarsTjeneste, pdfGeneratorTjeneste);
    }
    ...
    class CreatePdfTest {
        ...
        void skalStøtteAlleStylingTyper(DokCssStyling styling) {
            ...
            // Act & Assert - skal ikke kaste exception
            dokGeneratorTjeneste.createPdf(malNavn, dataFelter, DokSpråk.BOKMÅL, styling);
        }
    }
