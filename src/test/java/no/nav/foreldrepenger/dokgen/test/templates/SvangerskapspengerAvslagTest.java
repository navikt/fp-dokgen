...
class SvangerskapspengerAvslagTest {
    ...
    @Test
    void bruker_har_ikke_tilstrekkelig_opptjening_nb() throws Exception {
    ...
    @Test
    void bruker_har_ikke_tilstrekkelig_opptjening_nn() throws Exception {
    ...
    @Test
    void bruker_kan_arbeide_ingen_risiko_nb() throws Exception {
    ...
    @Test
    void bruker_kan_arbeide_ingen_risiko_nn() throws Exception {
    ...
    @Test
    void bruker_har_ikke_sendt_nødvendig_dokumentasjon_nb() throws Exception {
    ...
    @Test
    void bruker_har_ikke_sendt_nødvendig_dokumentasjon_nn() throws Exception {
