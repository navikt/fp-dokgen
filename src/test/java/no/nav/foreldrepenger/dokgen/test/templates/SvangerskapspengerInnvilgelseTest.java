...
class SvangerskapspengerInnvilgelseTest {
    ...
    @Test
    void svp_innvilgelse_fgb_at_fl_sn_nb() throws Exception {
    ...
    @Test
    void svp_innvilgelse_fgb_at_fl_sn_nn() throws Exception {
    ...
    @Test
    void svp_innvilgelse_fgb_at_fl_sn_en() throws Exception {
    ...
    @Test
    void svp_innvilgelse_fgb_sn_nb() throws Exception {
    ...
    @Test
    void svp_innvilgelse_fgb_sn_fritekst_beregning_nb() throws Exception {
    ...
    @Test
    void svp_innvilgelse_revurdering_at_fl_nb() throws Exception {
    ...
    @Test
    void svp_innvilgelse_2_arbeidsforhold_1_periode_hver() throws Exception {
    ...
    @Test
    void svp_innvilgelse_1_arbeidsforhold_1_periode() throws Exception {
