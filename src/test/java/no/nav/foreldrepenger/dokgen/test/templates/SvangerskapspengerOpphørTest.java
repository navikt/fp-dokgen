...
class SvangerskapspengerOpphørTest {
    ...
    @Test
    void bruker_har_mottatt_sykepenger_nb() throws Exception {
    ...
    @Test
    void bruker_har_mottatt_sykepenger_nn() throws Exception {
    ...
    @Test
    void bruker_har_mottatt_sykepenger_en() throws Exception {
    ...
    @Test
    void test_søker_død_nb() throws Exception {
    ...
    @Test
    void test_søker_død_nn() throws Exception {
    ...
    @Test
    void test_søker_død_en() throws Exception {
    ...
    @Test
    void bruker_er_ikke_medlem_nb() throws Exception {
    ...
    @Test
    void bruker_er_ikke_medlem_nn() throws Exception {
    ...
    @Test
    void bruker_er_ikke_medlem_en() throws Exception {
    ...
    @Test
    void bruker_er_ikke_gravid_nb() throws Exception {
    ...
    @Test
    void bruker_er_ikke_gravid_nn() throws Exception {
    ...
    @Test
    void bruker_er_ikke_gravid_en() throws Exception {
    ...
    @Test
    void barn_død_nb() throws Exception {
    ...
    @Test
    void barn_død_nn() throws Exception {
    ...
    @Test
    void barn_død_en() throws Exception {
