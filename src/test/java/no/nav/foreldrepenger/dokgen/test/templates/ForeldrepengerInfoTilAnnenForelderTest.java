...
class ForeldrepengerInfoTilAnnenForelderTest {
    ...
    @Test
    void infobrev_nb() throws Exception {
    ...
    @Test
    void infobrev_nn() throws Exception {
    ...
    @Test
    void infobrev_en() throws Exception {
    ...
    @Test
    void infobrev_ikke_sammenhengende_uttak_nb() throws Exception {
    ...
    @Test
    void infobrev_ikke_sammenhengende_uttak_nn() throws Exception {
    ...
    @Test
    void infobrev_ikke_sammenhengende_uttak_en() throws Exception {
    ...
    @Test
    void infobrev_opphold_nb() throws Exception {
    ...
    @Test
    void infobrev_opphol_nn() throws Exception {
    ...
    @Test
    void infobrev_opphold_en() throws Exception {
