...
public class InnvilgetForeldrepengerUtbetalingTest {
    ...
    public void undermal_utbetaling_ingen_refusjon_nb() throws Exception {
        assertThat(compileContent(BREVMAL, UNDERMAL, Språk.BOKMÅL, "utbetaling/førstegangsbehandling_ingen_refusjon"))
    ...
    public void undermal_utbetaling_full_refusjon_rettigheter_nb() throws Exception {
        assertThat(compileContent(BREVMAL, UNDERMAL, Språk.BOKMÅL, "utbetaling/førstegangsbehandling_full_refusjon"))
    ...
    public void undermal_utbetaling_delvis_refusjon_rettigheter_nb() throws Exception {
        assertThat(compileContent(BREVMAL, UNDERMAL, Språk.BOKMÅL, "utbetaling/førstegangsbehandling_delvis_refusjon"))
