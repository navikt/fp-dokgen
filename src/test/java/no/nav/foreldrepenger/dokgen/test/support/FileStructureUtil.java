...
class FileStructureUtil {
    ...
    static Path getTemplatePath(String templateName, String språk) {
        return CONTENT_ROOT.resolve("templates/" + templateName + språk + ".hbs");
    }

    static Path getTestDataPath(String templateName, String testDataName) {
    ...
    static Path getExpectedPath(String templateName, String expectedFileName) {
