...
public class InnsynTest {
    ...
    public void innsynInnvilget_nb() throws Exception {
        assertThat(compileContent(TEMPLATE_NAME, TEMPLATE_PATH, "nb", "innsyn_innvilget"))
    ...
    public void innsynDelvisInnvilget_nb() throws Exception {
        assertThat(compileContent(TEMPLATE_NAME, TEMPLATE_PATH, "nb", "innsyn_delvis_innvilget"))
    ...
    public void innsynAvvist_nb() throws Exception {
        assertThat(compileContent(TEMPLATE_NAME, TEMPLATE_PATH, "nb", "innsyn_avvist"))
    ...
    public void innsynAvvist_nn() throws Exception {
        assertThat(compileContent(TEMPLATE_NAME, TEMPLATE_PATH, "nn", "innsyn_avvist"))
    ...
    public void innsynDelvisInnvilget_nn() throws Exception {
        assertThat(compileContent(TEMPLATE_NAME, TEMPLATE_PATH, "nn", "innsyn_delvis_innvilget"))
    ...
    public void innsynInnvilget_nn() throws Exception {
        assertThat(compileContent(TEMPLATE_NAME, TEMPLATE_PATH, "nn", "innsyn_innvilget"))
    ...
    public void innsynAvvist_en() throws Exception {
        assertThat(compileContent(TEMPLATE_NAME, TEMPLATE_PATH, "en", "innsyn_avvist"))
    ...
    public void innsynDelvisInnvilget_en() throws Exception {
        assertThat(compileContent(TEMPLATE_NAME, TEMPLATE_PATH, "en", "innsyn_delvis_innvilget"))
    ...
    public void innsynInnvilget_en() throws Exception {
        assertThat(compileContent(TEMPLATE_NAME, TEMPLATE_PATH, "en", "innsyn_innvilget"))
