...
class ForeldrepengerInnvilgelseInnvilgetTest {
    ...
    @Test
    void skal_fortelle_om_innvilget_uttak_med_prosent_nb() throws Exception {
    ...
    @Test
    void skal_fortelle_om_innvilget_fullt_uttak_uten_prosent_nb() throws Exception {
    ...
    @Test
    void skal_liste_ut_arbeidsforhold_2_med_deltidstekst_og_arbeidsforhold_3_med_selvom_tekst_og_arbeidsforhold_4_med_permisjonstekst() throws Exception {
    ...
    @Test
    void skal_liste_ut_annen_aktivitet_når_det_er_frilans_med_gradering_og_næring_når_det_er_gradering() throws Exception {
    ...
    @Test
    void skal_liste_ut_tekster_for_alle_årsakene_som_finnes_i_periodelista_nb() throws Exception {
    ...
    @Test
    void skal_liste_ut_tekster_for_alle_årsakene_som_finnes_i_periodelista_nn() throws Exception {
    ...
    @Test
    void skal_liste_ut_tekster_for_alle_årsakene_som_finnes_i_periodelista_en() throws Exception {
    ...
    @Test
    void skal_ikke_bruke_punktliste_når_bare_en_periode_er_innvilget() throws Exception {
