...
class ForeldrepengerAnnullertI18nTest {
    ...
    void skal_generere_foreldrepenger_annullert_pga_søknad_fra_bruker(Språk språk) {
        var content = compileContentI18n(BREVMAL, språk, "test_fp_annullert_pga_søknad_fra_bruker");
    ...
    void skal_generere_foreldrepenger_annullert_pga_innvilget_pleiepenger(Språk språk) {
        var content = compileContentI18n(BREVMAL, språk, "test_fp_annullert_pga_innvilget_pleiepenger");
    ...
    void skal_generere_foreldrepenger_annullert_pga_innvilget_annen_part(Språk språk) {
        var content = compileContentI18n(BREVMAL, språk, "test_fp_annullert_pga_annen_part_overtar_uttaket");
    ...
    void skal_generere_foreldrepenger_annullert_pga_søknad_ny_periode(Språk språk) {
        var content = compileContentI18n(BREVMAL, språk, "test_fp_annullert_pga_søknad_ny_periode");
